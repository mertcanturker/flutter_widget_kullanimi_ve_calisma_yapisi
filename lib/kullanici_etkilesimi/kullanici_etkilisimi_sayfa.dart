...
class KullaniciEtkilisimiSayfa extends StatefulWidget {
  const KullaniciEtkilisimiSayfa({super.key});

  @override
  State<KullaniciEtkilisimiSayfa> createState() => _KullaniciEtkilisimiSayfaState();
}

class _KullaniciEtkilisimiSayfaState extends State<KullaniciEtkilisimiSayfa> {
